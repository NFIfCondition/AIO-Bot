...
export function mutemessage(member: GuildMember | APIInteractionGuildMember, interaction: CommandInteraction, user: GuildMember, reason: string | undefined){
    let _reason = reason
    ...
    if (member){
        const mute = new MessageEmbed()
            ...
            .addFields(
                ...
                {name: 'Wurde unmuted von', value: member.user.username},
